        ...
        <v-col cols="12" xs="12" md="6" class="text-md-left text-center">
          ...
          <p class="black--link">
            ...
            <nuxt-link :to="localePath('openness_to_experience')">
              {{ $t("facets.openness_to_experience.title") }} </nuxt-link
            >,
            <nuxt-link :to="localePath('conscientiousness')">
              {{ $t("facets.conscientiousness.title") }} </nuxt-link
            >,
            <nuxt-link :to="localePath('extraversion')">
              {{ $t("facets.extraversion.title") }} </nuxt-link
            >,
...
export default {
  ...
  methods: {
    ...mapMutations(["SET_TWITTER_USERNAME"])
  }
};
</script>
